    ...
    <main className="relative w-full overflow-x-hidden bg-black cursor-none">
      ...
      <section className="relative w-full h-screen z-10 pointer-events-none">
        ...
        <div className="absolute top-8 right-4 md:top-12 md:right-12 text-right">
          ...
          <p className="font-secondary text-[0.55rem] sm:text-[0.65rem] md:text-xs text-green-500 font-bold uppercase tracking-[0.2em]">Security Researcher</p>
        </div>
        <div className="absolute bottom-8 left-0 w-full flex justify-between px-4 md:px-24 pointer-events-auto">
          {["OFFENSE", "DEFENSE", "ENGINEERING"].map((item, idx) => (
            <div key={idx} className="flex flex-col items-center gap-2 group cursor-pointer interactive">
              <span className="text-green-500 font-primary text-lg md:text-xl group-hover:scale-150 transition-transform duration-300">+</span>
      ...
      <section ref={section2Ref} className="relative w-full min-h-screen bg-black z-20 flex flex-col items-center justify-center px-6 md:px-8 py-20 md:py-24 overflow-hidden">
        <div ref={fluidRef} className="absolute top-1/2 left-1/2 w-[300px] h-[300px] md:w-[400px] md:h-[400px] rounded-full mix-blend-screen pointer-events-none -translate-x-1/2 -translate-y-1/2 origin-center bg-[radial-gradient(circle_at_center,rgba(0,200,0,0.8)_0%,rgba(0,200,0,0)_70%)]" />
        <div className="max-w-4xl mx-auto text-center mb-24 md:mb-32 relative z-30 mix-blend-difference">
          <p ref={statementRef} className="font-secondary text-lg md:text-4xl text-white font-medium leading-relaxed tracking-wide">
            ...
            <br />
              <span className="text-green-500 font-primary italic text-3xl md:text-6xl pr-2">I secure and break them.</span> <br />
            <br />
        ...
        <div ref={metricsRef} className="w-full max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-16 text-center relative z-30">
          <div className="flex flex-col items-center">
            <h2 className="metric-number font-primary text-7xl md:text-9xl text-green-500 tracking-tighter mb-4">10+</h2>
            <p className="font-secondary text-xs text-zinc-400 uppercase tracking-[0.2em] font-semibold">Web Projects Built</p>
          </div>
          <div className="flex flex-col items-center">
            <h2 className="metric-number font-primary text-7xl md:text-9xl text-green-500 tracking-tighter mb-4">15+</h2>
            <p className="font-secondary text-xs text-zinc-400 uppercase tracking-[0.2em] font-semibold">Security Certificates</p>
          </div>
          <div className="flex flex-col items-center">
            <h2 className="metric-number font-primary text-7xl md:text-9xl text-green-500 tracking-tighter mb-4">50+</h2>
        ...
        <div className="mt-24 text-center relative z-30">
          <p className="font-secondary text-[0.65rem] md:text-sm text-green-600 uppercase tracking-[0.5em] font-bold">RESPONSIBLE DISCLOSURE. ZERO DAYS.</p>
        </div>
      </section>
      ...
      <section ref={section34Ref} className="relative w-full h-screen bg-black z-30 overflow-hidden flex items-center justify-center cursor-none">
        ...
        <div className="absolute inset-0 z-0 bg-[linear-gradient(to_right,#001a00_1px,transparent_1px),linear-gradient(to_bottom,#001a00_1px,transparent_1px)] bg-[size:4rem_4rem] opacity-30 pointer-events-none" />

        {/* Floating Glitch Elements */}
        <div className="absolute inset-0 z-10 pointer-events-none mix-blend-screen">
          <div ref={glitch1Ref} className="absolute top-[20%] left-[15%] w-32 h-48 bg-green-900/40" style={{ boxShadow: "0 0 20px #00ff00" }} />
          <div ref={glitch2Ref} className="absolute bottom-[20%] right-[15%] w-48 h-32 bg-green-900/40" style={{ boxShadow: "0 0 20px #00ff00" }} />
        </div>
        ...
        <div ref={techTextRef} className="absolute right-8 md:right-24 top-1/2 -translate-y-1/2 z-20 opacity-0 text-right pointer-events-none">
          <p className="font-secondary text-green-400 text-xs tracking-widest leading-loose">
        ...
        <div className="relative z-40 w-full h-full flex flex-col items-center justify-center pointer-events-none">
          <h1 ref={textLegacyRef} className="absolute font-primary font-semibold text-[15vw] leading-none tracking-tighter opacity-100 text-transparent" style={{ WebkitTextStroke: "2px #00ff00" }}>HUNT</h1>
          <h1 ref={textUiUxRef} className="absolute font-primary font-semibold text-[15vw] leading-none tracking-tighter opacity-0 scale-50 text-transparent" style={{ WebkitTextStroke: "2px #00ff00" }}>EXPLOIT</h1>
          <h1 ref={text3dWebRef} className="absolute font-primary font-semibold text-[15vw] leading-none tracking-tighter opacity-0 scale-50 text-transparent" style={{ WebkitTextStroke: "2px #00ff00" }}>SECURE</h1>
        </div>

        {/* THE CUSTOM CURSOR IMAGE BOX (Section 3) */}
        <div ref={cursorBoxRef} className="absolute top-0 left-0 w-[300px] h-[300px] pointer-events-none overflow-hidden z-30 border border-green-500/30 bg-[#001100]">
           ...
           <div className="absolute inset-0 bg-[#00ff00]/10 mix-blend-multiply" />
        </div>

        {/* THE VIDEO PORTAL (Section 4 Reveal) */}
        <div ref={videoPortalRef} className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] z-35 overflow-hidden flex items-center justify-center opacity-0 pointer-events-none border border-green-500/30 bg-[#001100]">
           <video 
        ...
        <div ref={narrativeRef} className="absolute inset-0 z-50 w-full h-full flex flex-col justify-center md:flex-row md:items-center md:justify-between px-8 md:px-24 opacity-0 pointer-events-none">
           <p className="font-secondary text-white text-4xl md:text-6xl md:w-1/3 leading-tight text-center md:text-left mb-8 md:mb-0 font-medium">
             The fall was <br className="hidden md:block"/>
             always <br className="hidden md:block"/>
             <span className="font-primary text-[#00ff00] italic font-light text-5xl md:text-7xl lowercase pl-2 pr-1 drop-shadow-[0_0_10px_rgba(0,255,0,0.5)]">part</span> of the path.
           </p>
           <p className="font-secondary text-white text-sm md:text-xl md:w-1/4 text-center md:text-right font-medium leading-relaxed">
             And from that point,<br/> everything began to rebuild<br/> with intention.
           </p>
        </div>
        ...
        <div className="absolute inset-0 z-0 pointer-events-none opacity-30">
          <svg viewBox="0 0 100 100" preserveAspectRatio="none" className="w-full h-full">
            <g stroke="#00ff00" strokeWidth="0.2" fill="none">
              {/* Center Lines */}
